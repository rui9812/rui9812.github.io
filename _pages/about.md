...
<div style="text-align:center; background: linear-gradient(to bottom, #e0f0ff, #c0d8ff, #a0c4ff); padding:15px; border-radius:12px; margin-bottom:20px; color: #003366; font-family: 'Montserrat', sans-serif; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
  <h2 style="font-size:1.6em; margin:0; border-bottom: none; text-decoration: none;">
...
<div style="background-color: #fef2f2; border-left: 4px solid #ef4444; padding: 10px 15px; margin: 20px 0; border-radius: 4px;">
  <p style="color: #b91c1c; margin: 0; font-size: 0.95em;">💡 I am currently seeking internship opportunities related to <b>Self-Evolving Agent/RAG Systems</b>. Please feel free to contact me if you are interested in my research or background.</p>
</div>
